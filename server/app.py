...
#     existing_like = Like.query.filter_by(user_id=user.id, food_id=food.id).first()
#     if existing_like:
#         return jsonify({'error': 'Food already liked by this user'}), 400

#     # Add the like
#     new_like = Like(user_id=user.id, food_id=food.id)
